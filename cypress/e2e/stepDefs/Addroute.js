...
When(`I click on the add route button`, () => {
    cy.get(addroute.addroute).click()
    cy.wait(500)
});
...
When(`I enter the route details`, () => {
   ...
   cy.get(addroute.submitaddress2).first().click();
   cy.wait(500);
   ...
   cy.get(addroute.date2).eq(1).type('2025-02-28')
    ...
    cy.wait(200)
    cy.get(addroute.reservtionum).type('123456789')
    cy.get(addroute.tripnumber).type('123456789')
